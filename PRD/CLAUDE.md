...
- **UI consistency plan complete:** all six stages done ([BUILD_UI-redesign.md](BUILD_UI-redesign.md)). One decision is open for the user - Report's Full / Custom sits at level 3b rather than the config-pane pills D8 names, because D11 leaves Custom with no result surface
